...
main() {
    ...
    while(t--) {
        ...
        add(n-1, 1, 0, 0, 1, 0, 1, 1);
        add(n-1, m-1, 0, 1, 1, 0, 1, 1);

        for (int i=1; i<=m-2; i++) {
            if (table[n][i] == 1) {
                add(n-1, i, 0, 0, 0, 1, 1, 0);
            } else {
                add(n-1, i, 0, 0, 0, 1, 1, 1);
            }
        }

        if (table[n][m-1] == 0 && table[n][m] == 0) {
            add(n-1, m-1, 0, 0, 1, 0, 1, 1);
            add(n-1, m-1, 0, 1, 1, 0, 1, 1);
        } else if (table[n][m-1] == 1 && table[n][m] == 0) {
            add(n-1, m-1, 0, 0, 0, 1, 1, 0);
        } else if (table[n][m-1] == 0 && table[n][m] == 1) {
            add(n-1, m-1, 0, 0, 0, 1, 1, 1);
        } else if (table[n][m-1] == 1 && table[n][m] == 1) {
            add(n-1, m-1, 0, 0, 0, 1, 1, 0);
            add(n-1, m-1, 0, 0, 0, 1, 1, 1);
            add(n-1, m-1, 0, 0, 1, 0, 1, 1);
            add(n-1, m-1, 0, 1, 1, 0, 1, 1);
